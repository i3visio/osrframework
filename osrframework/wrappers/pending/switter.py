    ...
    def __init__(self):
        ...
        self.modes = {
            "usufy": {
                ...
                "not_found_text": ["<img alt='Mastodon' src='/oops.png'>", "<head><title>503 S"],                   # Text that indicates a missing profile
                "query_validator": "[a-z0-9A-Z_]+",                            # Regular expression that the alias SHOULD match
                "url": "https://switter.at/@{placeholder}",       # Target URL where {placeholder} would be modified by the alias
            },
