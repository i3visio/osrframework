...
class Ukdebate(Platform):
    ...
    def __init__(self):
        ...
        self.url["usufy"] = "http://www.ukdebate.co.uk/forums/index.php?action=profile;user=" + "<usufy>"       
        ...
        self.notFoundText["usufy"] = ["Grrr, it looks like you are having problems doing something on the UK Debate."]
