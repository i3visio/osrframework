...
- `domainfy`. Finds domains that currently resolve using a given word or nickname. **Input**: list of words. **Output**: domains using that word that currently resolve.
